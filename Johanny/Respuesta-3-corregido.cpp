...
candidatos en una elecci�n presidencial. El programa debe:
...
void votosTotales(int* votos){
	...
	cout<<"Ganador: "<<endl;
	if (*votos==*(votos+1)&&*votos==*(votos+2)) cout<<"Hubo un empate triple"<<endl;
	else if(empate){
		cout<<"Hubo un empate entre los candidatos "<<indiceEmpate+1<<" y "<<ganador-votos+1<<endl;
	} else {
